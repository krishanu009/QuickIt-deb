...
function Footer() {
  return (
    <footer class="flex flex-col space-y-10 justify-center m-10 pt-10 pb-20">
    ...
    <p class="text-center text-gray-700 font-medium">&copy; 2024 Quick It Ltd. All rights reservered.</p>
</footer>
  )
}
